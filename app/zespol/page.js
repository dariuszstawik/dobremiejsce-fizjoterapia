...
const specialists = [
  ...
  },
  {
    ...
    name: "Anna Plaszczyk",
    role: "Fizjoterapeuta dziecięcy",
    photo: "/anna-plaszczyk.webp",
    href: "/anna-plaszczyk",
  },
  {
    id: 6,
    name: "Aleksandra Deninger",
    role: "Fizjoterapeuta dziecięcy",
    photo: "/aleksandra-deninger.webp",
    href: "/aleksandra-deninger",
  },
  {
    id: 7,
    name: "Julianna Gwóźdź",
    role: "Fizjoterapeuta dziecięcy",
    photo: "/julianna-gwozdz.webp",
    href: "/julianna-gwozdz",
  },
  {
    id: 8,
    name: "Jakub Śmistek",
...
// Dzieli listę na możliwie równe rzędy, tak aby ostatni rząd
// nigdy nie zawierał pojedynczej osoby. Dla 13 -> [4, 3, 3, 3].
function balanceRows(items, maxPerRow = 4) {
...
function SpecialistCard({ specialist }) {
  ...
  const card = (
    <div
      ...
      style={{ "--accent": accent, maxWidth: "220px", margin: "0 auto" }}
    >
...
export default function TeamSection() {
  const rows = balanceRows(specialists, 4);
  let counter = 0; // globalny licznik do animacji fadeInUp
            ...
            {rows.map((row, rowIdx) => (
              <div
                ...
                style={{
                  ...
                  justifyContent: "center",
                  gap: "28px",
                  marginBottom: rowIdx === rows.length - 1 ? 0 : "40px",
                }}
              >
                {row.map((s) => {
                  const delay = counter++ * 0.07;
                  return (
                    <div
                      key={s.id}
                      style={{
